...
<form action="" style="text-align: -webkit-center;" >
		...
		<?php
				...
				while($row=mysqli_fetch_assoc($result)){
					echo "<tr>";
				echo "<td>".$row['user_id']."</td>"."<td>".$row['name']."</td>"."<td>".$row['type']."</td>"."<td>".$row['email']."</td>"."<td>".$row['status']."</td>"."<td>".$row['password']."</td>"."<td>"."<button><a href='update.php?id=$row[user_id]'>Edit</a></button>"."</td>";
					echo "</tr>";
